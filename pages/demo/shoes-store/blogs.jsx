...
import { shoesBlogs } from "src/mock/shoesProducts";

const ShoesBlogs = (props) => {
  return (
    <StyledPage>
      {/* <Breadcrumb title="BLOG" link="HOME / SHOES STORE / BLOGS" className="mt-5" /> */}
      <div className="pagination-sec mt-5">
        <Row className="d-flex justify-content-end align-items-center">
          ...
          >
           <Link href="/">
              <p className="m-0 mx-1"> SHOE-STORE /</p>
            </Link>
            <Link href="/">
      ...
      <div style={{ padding: 80 }} className="detail-section">
        <Row gutter={[30, 30]} className="flex-column-reverse flex-lg-row">
          <Col lg={18} sm={24} xs={24}>
            {shoesBlogs.map((item, index) => {
              return <BlogListingCard key={index} {...item} />;
            })}
          </Col>
          <Col lg={6} sm={24} xs={24}>
            <RecentBlogs data={shoesBlogs} />
